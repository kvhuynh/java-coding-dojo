		...
		<div class="container mt-5 d-flex flex-column">
			<div class="header d-flex justify-content-between">
				<div class="header-left">
					<h1><c:out value="${classInfo.className}"/></h1>
				</div>
			...
			<div>
				<form:form action="/classes/${classInfo.id}/update" modelAttribute="classInfo" class="d-flex flex-column col-6" method="POST">
				...
				<div>
					<a href="/classes" class="btn btn-light mr-5">Cancel</a>
					<input type="submit" class="btn btn-primary" value="Submit"/>
				</div>		
				</form:form>
				<form action="/classes/${classInfo.id}/delete" method="POST">
